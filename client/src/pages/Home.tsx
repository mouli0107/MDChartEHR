      ...
      <section className="py-20 bg-white border-b border-slate-100">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.p variants={fadeInUp} className="text-lg text-slate-600 mb-8 leading-relaxed"> At MD Charts, we help medical practices simplify daily work with intuitive, specialty-focused technology. Our platform brings charting, scheduling, documentation, coding, and medical billing together in one connected experience, so providers can spend less time clicking and more time caring for patients.</motion.p>
<motion.p variants={fadeInUp} className="text-lg text-slate-600 mb-8 leading-relaxed"> Whether a practice needs dermatology EMR, OBGYN EMR, or flexible EMR software for a growing team, our solutions are designed to support real clinical workflows with clarity, speed, and confidence.</motion.p>
