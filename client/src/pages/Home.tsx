        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { quote: "I have been using MD Charts for over a decade, and it has made a tremendous difference in our practice. Its user-friendly design has helped simplify many of our administrative tasks, allowing our team to focus more on patient care and less on paperwork. The reports provide meaningful insights that help us manage our practice more effectively, and the support team has always been outstanding — responsive, knowledgeable, and helpful whenever we need assistance.", name: "Pamela Brandy", role: "Senior Operations Manager, GNOB" },
              { quote: "As a medical assistant, I find MD Charts easy to navigate. Whether I'm preparing charts, entering patient information, or helping providers during visits, everything is easy to locate and use. It helps me stay organized throughout the day.", name: "Brenda Figueroa", role: "Senior Medical Assistant" },
              { quote: "For the first time in my career, I truly feel that I have my finger on the financial pulse of my practice. The MD Charts RCM team is knowledgeable, responsive, and a pleasure to work with. Their attention to detail has given me tremendous confidence that my billing is being managed the right way. I recommend them without hesitation.", name: "Meyer Abittan, M.D., FACC", role: "Cardiologist" },
